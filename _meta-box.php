...
//call the meta box function
smashing_post_meta_boxes_setup();

/* ---------------------------------------------------------------
 * 2.Create the meta boxes and decide where to display them
 * ---------------------------------------------------------------
*/
function smashing_add_post_meta_boxes() {
  $screens = ['page', 'projects'];
...
/* ---------------------------------------------------------------
 * 4. Filter the post class hook with custom post class function.
 * ---------------------------------------------------------------
*/
add_action( "post_class", 'smashing_post_class' );
